...
- **Безопасность:** Конфигурации сохраняются локально (`writefile`) на устройстве пользователя. Исполняемый код изолирован контейнером Roblox. Подробности читайте в файле `SECURITY.md`.
